...
fn create_builtin_env_map(preset: IblPreset) -> (u32, u32, Vec<f32>, [f32; 4], [f32; 4]) {
    ...
    let (sky, horizon, ground, sun_boost, ibl_diffuse, ibl_specular) = match preset {
        IblPreset::Neutral => (
            [0.14_f32, 0.15_f32, 0.16_f32],
            [0.10_f32, 0.10_f32, 0.10_f32],
            [0.03_f32, 0.03_f32, 0.03_f32],
            1.2_f32,
            [0.15, 0.15, 0.15, 1.0],
            [0.22, 0.22, 0.22, 1.0],
        ),
        IblPreset::Studio => (
            [0.16_f32, 0.20_f32, 0.28_f32],
            [0.12_f32, 0.12_f32, 0.12_f32],
            [0.03_f32, 0.03_f32, 0.03_f32],
            2.4_f32,
            [0.16, 0.16, 0.16, 1.0],
            [0.26, 0.26, 0.26, 1.0],
        ...
        IblPreset::Warm => (
            [0.24_f32, 0.20_f32, 0.16_f32],
            [0.15_f32, 0.12_f32, 0.10_f32],
            [0.04_f32, 0.03_f32, 0.02_f32],
            2.0_f32,
            [0.18, 0.15, 0.12, 1.0],
            [0.28, 0.23, 0.18, 1.0],
        ),
