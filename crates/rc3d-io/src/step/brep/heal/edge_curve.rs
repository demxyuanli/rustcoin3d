...
use crate::step::brep::topo::{Orientation, WireKey, FaceKey};
...
pub fn fix_edge_curves(
    shell_key: crate::step::brep::topo::ShellKey,
    reg: &mut BRepRegistry,
    tolerance: f32,
) -> usize {
    let face_keys: Vec<_> = {
...
mod tests {
    ...
    use crate::step::brep::topo::{BRepEdge, BRepFace, BRepShell, BRepWire, WireKey};
    use std::collections::HashMap;

    fn make_shell_with_line_edge(reg: &mut BRepRegistry, endpoint_offset: f32) -> crate::step::brep::topo::ShellKey {
