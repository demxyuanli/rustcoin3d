...
mod tests {
    ...
    fn test_intersect_finds_crossing_planes() {
        ...
        let e01 = reg.edges.insert(BRepEdge { curve: CurveGeom::Line { origin: PVec3::new(-1.0, -1.0, 0.0), direction: PVec3::new(2.0, 0.0, 0.0) }, tolerance: 1e-4, v_low: lo01, v_high: hi01, t_min: 0.0, t_max: 1.0, cached_deflection: None, pcurves: HashMap::new() });
        let e12 = reg.edges.insert(BRepEdge { curve: CurveGeom::Line { origin: PVec3::new(1.0, -1.0, 0.0), direction: PVec3::new(0.0, 2.0, 0.0) }, tolerance: 1e-4, v_low: lo12, v_high: hi12, t_min: 0.0, t_max: 1.0, cached_deflection: None, pcurves: HashMap::new() });
        let e23 = reg.edges.insert(BRepEdge { curve: CurveGeom::Line { origin: PVec3::new(1.0, 1.0, 0.0), direction: PVec3::new(-2.0, 0.0, 0.0) }, tolerance: 1e-4, v_low: lo23, v_high: hi23, t_min: 0.0, t_max: 1.0, cached_deflection: None, pcurves: HashMap::new() });
        let e30 = reg.edges.insert(BRepEdge { curve: CurveGeom::Line { origin: PVec3::new(-1.0, 1.0, 0.0), direction: PVec3::new(0.0, -2.0, 0.0) }, tolerance: 1e-4, v_low: lo30, v_high: hi30, t_min: 0.0, t_max: 1.0, cached_deflection: None, pcurves: HashMap::new() });
        ...
        let e45 = reg.edges.insert(BRepEdge { curve: CurveGeom::Line { origin: PVec3::new(-1.0, 0.0, -1.0), direction: PVec3::new(2.0, 0.0, 0.0) }, tolerance: 1e-4, v_low: lo45, v_high: hi45, t_min: 0.0, t_max: 1.0, cached_deflection: None, pcurves: HashMap::new() });
        let e56 = reg.edges.insert(BRepEdge { curve: CurveGeom::Line { origin: PVec3::new(1.0, 0.0, -1.0), direction: PVec3::new(0.0, 0.0, 2.0) }, tolerance: 1e-4, v_low: lo56, v_high: hi56, t_min: 0.0, t_max: 1.0, cached_deflection: None, pcurves: HashMap::new() });
        let e67 = reg.edges.insert(BRepEdge { curve: CurveGeom::Line { origin: PVec3::new(1.0, 0.0, 1.0), direction: PVec3::new(-2.0, 0.0, 0.0) }, tolerance: 1e-4, v_low: lo67, v_high: hi67, t_min: 0.0, t_max: 1.0, cached_deflection: None, pcurves: HashMap::new() });
        let e74 = reg.edges.insert(BRepEdge { curve: CurveGeom::Line { origin: PVec3::new(-1.0, 0.0, 1.0), direction: PVec3::new(0.0, 0.0, -2.0) }, tolerance: 1e-4, v_low: lo74, v_high: hi74, t_min: 0.0, t_max: 1.0, cached_deflection: None, pcurves: HashMap::new() });
