...
fn main() {
    ...
    let mut app = App::new(g)
        .with_camera_controller(CameraController::new(Vec3::ZERO, 10.0))
        .with_initial_post_effect_params(0.4, 0.01, 1.0, 0.02);
    println!("Post effects preset (applied after GPU init): vignette=0.4, chromatic=0.01, bloom=1.0, grain=0.02");
