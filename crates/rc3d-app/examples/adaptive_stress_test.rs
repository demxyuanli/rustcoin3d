...
fn main() {
    ...
    let mut app = App::new(scene)
        ...
        .with_adaptive_quality_mode(AdaptiveQualityMode::On)
        .with_panel_overlay_text_hook(move || {
            ...
            let lines = vec![
                ...
                "  High    — 45-60fps, full effects, 4 cascades @ 2048×2048".to_string(),
                "  Medium  — 30-45fps, reduced SSAO, 2 cascades @ 1024×1024".to_string(),
