...
fn approximate_node_center(graph: &SceneGraph, node: NodeId) -> Option<Vec3> {
    ...
    match &entry.data {
        ...
        NodeData::Group(_) | NodeData::IndexedLineSet(_) | NodeData::File(_) | NodeData::Decal(_) | NodeData::Billboard(_) | NodeData::Separator(_) | NodeData::Lod(_) | NodeData::Switch(_) | NodeData::MultipleCopy(_)
